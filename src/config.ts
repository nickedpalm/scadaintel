...
const config: SiteConfig = {
  ...
  // Legacy single-link fields used by billing.astro + ListingDetail.astro
  // upgrade CTAs. stripe_sync writes the *MonthlyLink variants; fall back
  // to those so the buttons work even when the legacy fields are empty.
  stripeSponsoredLink: d.stripeSponsoredLink || d.stripeFeaturedMonthlyLink || '',
  stripeCityProLink: d.stripeCityProLink || d.stripeCityProMonthlyLink || '',
